...
const UkmCard = ({ title, socialMedia, image }) => {
  return (
    <div className="w-full bg-white select-none dark:bg-slate-900 h-80 dark:shadow-none transition-all duratiion-300 flex items-center flex-col gap-4 justify-center shadow-md shadow-gray-200 rounded-xl hover:border hover:border-blue-600">
